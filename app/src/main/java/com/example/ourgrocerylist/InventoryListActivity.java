...
import com.example.ourgrocerylist.viewmodel.InventoryListViewModel;
import java.util.List;

public class InventoryListActivity extends AppCompatActivity implements InventoryListAdapter.HandleItemsClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Home Inventory");
        ...
        initViewModel();
        initRecyclerView();
        viewModel.getAllInventoryList();
    }

    private void initViewModel() {
        viewModel = new ViewModelProvider(this).get(InventoryListViewModel.class);
        viewModel.getInventoryListObserver().observe(this, new Observer<List<Items>>() {
            @Override
            public void onChanged(List<Items> items) {
                if (items == null) {
                    ...
                    inventoryListAdapter.setInventoryList(items);
    ...
    private void initRecyclerView() {
        ...
        inventoryListAdapter = new InventoryListAdapter(this, this);
        ...
        addItemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    Toast.makeText(InventoryListActivity.this, "Enter Category Name", Toast.LENGTH_SHORT).show();
                    return;
                }
